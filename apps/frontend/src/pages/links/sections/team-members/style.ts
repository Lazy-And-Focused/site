export const STYLE = {
  SECTION: 'flex min-h-screen w-full flex-col items-center justify-center px-6 py-14 lg:px-8',
  CONTAINER: 'mx-auto flex max-w-7xl flex-col gap-16 px-6 md:gap-14 lg:px-8',
  HEADER: 'max-w-xl',
