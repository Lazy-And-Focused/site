...
export class Controller {
  ...
  @Post(ROUTES.POST)
  public post(@Body() data: MemberCreateDto) {
  ...
  @Put(ROUTES.PUT)
  public put(@Param("slug") slug: string, @Body() data: MemberUpdateDto) {
  ...
  @Patch(ROUTES.PUT)
  public patch(@Param("slug") slug: string, @Body() data: MemberUpdateDto) {
