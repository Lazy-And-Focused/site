      ...
      <ul role='list' className={STYLE.LIST.CONTAINER}>
        <li className={STYLE.LIST.ITEM}>
          <span className={STYLE.LIST.DISABLED}>
            Аватары пользователей, как и их описания,{' '}
            <strong>принадлежат их владельцам</strong>
          </span>
        </li>
        <li className={STYLE.LIST.ITEM}>
          <span className={STYLE.LIST.SUPPLEMENT}>Дополнение: </span>
          <span className={STYLE.LIST.DISABLED}>
            принадлежат <strong>кроме тех случаев, когда</strong> авторское
            право соотносится с другим правообладателем
          </span>
        </li>
        <li className={STYLE.LIST.ITEM}>
          <span className={STYLE.LIST.DISABLED}>
            ...
            <strong>
              основываясь на данных из Интернет-ресурсов, если пользователь не
              предоставил
            </strong>{' '}
